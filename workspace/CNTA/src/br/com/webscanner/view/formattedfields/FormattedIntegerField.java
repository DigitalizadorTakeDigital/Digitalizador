...
import br.com.webscanner.view.formattedfields.verifiers.IntegerVerifier;


/**
 * Provides a JFormattedTextField that accepts only integer. Allows for the setting of  min/max values allowed.
 * 
