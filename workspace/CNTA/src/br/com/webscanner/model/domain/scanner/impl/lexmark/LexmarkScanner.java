package br.com.webscanner.model.domain.scanner.impl.lexmark;
...
public class LexmarkScanner implements Scannable {
	...
	private static Logger logger = LogManager.getLogger(LexmarkScanner.class.getName());
