 ...
 *
 */
public class TwainScanner implements Scannable {
	...
	private static final short MSG_XFERREADY = 0x0101; /*
														 * The data source has
														 * data ready
														 */
	private static final short MSG_CLOSEDSREQ = 0x0102; /*
														 * Request for
														 * Application. to close
														 * DS
														 */
	private static final short MSG_CLOSEDSOK = 0x0103; /*
														 * Tell the Application.
														 * to save the state.
														 */
	private static final short MSG_DEVICEEVENT = 0X0104; /*
														 * Some event has taken
														 * place Added 1.8
														 */
	...
	private static Logger logger = LogManager.getLogger(TwainScanner.class
			.getName());
	...
	*/
	...
	@Override
	public boolean acquire() throws ScannerObstructedException,
			DriverNotInstalledException, ScannerDoubleFeedException,
...
//	}
	...
	@Override
	public boolean hasMoreImages() throws ScannerObstructedException,
	...
	private Image getImage() throws ScannerException {
		...
		if (point == 0) {
			throw new ScannerImageNotFoundException(
					"Ponteiro retornou 0 na recuperação da imagem");
		}
