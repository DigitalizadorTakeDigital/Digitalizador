...
public class MoveToController {
	private static Logger logger = LogManager.getLogger(MoveToController.class.getName());
	...
	public MoveToController(ProductScannerController controller) {
	...
	public void moveTo(JTable table, Integer from, Integer to) {
		controller.moveTo(table, from, to);
	}
